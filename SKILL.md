---
name: paimon-skill
description: 原神专用 AI 游戏伴侣（play-any-game 子模块）。当你在原神中遇到困难、卡关、不知道怎么操作时，派蒙可以帮你分析游戏画面、解答问题、甚至简单操作界面帮你解决问题。派蒙是旅行者的应急食品和最好的伙伴，会在你需要时伸出援手。此模块依赖父模块 play-any-game 的核心能力，仅在用户明确提到原神相关场景时激活。
---

# 🌟 派蒙.skill - play-any-game 原神特化模块
